...
describe("Comments Widget", () => {
    var singleCommentJSON = {id: 1, msg: "First Comment", user: "Naresh", updatedOn: "2014-09-19T15:28:46.493Z", likes: 1}
    ...
    //<editor-fold desc="Should give a nice message when there are no comments">
    ...
    //<editor-fold desc="Should add single comment as a div from passed in json">
    ...
    //<editor-fold desc="Should display the most recent comments on top">
    ...
    //<editor-fold desc="Should not display private comments to other logged in user">
    ...
    //<editor-fold desc="Should not display private comments to public">
    ...
    //<editor-fold desc="Should display private comments to author">
    ...
    //<editor-fold desc="Should fetch data from URL and display comments">
    ...
    //<editor-fold desc="Should try to fetch data from URL and display error message when unsuccessful">
